...
struct entry t8103_ane_dpe_sys_tunables[] = {
...
struct entry t8103_ane_perf_tunables[] = {
...
struct entry t8103_ane_dpe_soc_tunables[] = {
...
int tunables_apply_static(void)
{
    ...
    switch (chip_id) {
        case T8103:
            ...
            ret |= power_and_apply("/arm-io/ane", 0x26b8f0000, t8103_ane_dpe_sys_tunables);
            ret |= power_and_apply("/arm-io/ane", 0x26b908000, t8103_ane_perf_tunables);
            ret |= power_and_apply("/arm-io/ane", 0x26b8f4000, t8103_ane_dpe_soc_tunables);
            break;
        case T8112:
